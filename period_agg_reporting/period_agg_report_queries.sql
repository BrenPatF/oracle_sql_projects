@..\initspool period_agg_report_queries
...
/
l
EXEC  Utils.W(Utils.Get_XPlan(p_sql_marker => 'XPLAN_MARKER_UGB'));
EXEC  Utils.W(Utils.Get_XPlan(p_sql_marker => 'XPLAN_MARKER_AAG'));
EXEC  Utils.W(Utils.Get_XPlan(p_sql_marker => 'XPLAN_MARKER_GBC'));
